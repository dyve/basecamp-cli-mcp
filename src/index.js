...
// Reads the CLI's own classification rather than matching on message text: the
// envelope's `code` and exit status both say `auth_required` outright.
function isAuthFailure(e) {
  return describeCliError(e).code === "auth_required";
}
